...
source('./code/func_fix_trimfill.R')
...
for (f in names(rds_list)) {
  ...
  ##' --> 1. usually work
  # trimfill_result <- meta::trimfill(ma_smd)
  # summary(trimfill_result)
  
  ##' --> 2. work around 
  ##' In case the base function `trimfill()` would report error due to bersion change, 
  ##' You can try using the following customized one to fix the potential error
